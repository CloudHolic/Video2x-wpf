...
FFMPEG_PATH = str(Path(os.path.dirname(os.path.realpath(__file__))).parent) +"/ffmpeg/bin/"
# waifu2x executable path. Mind all the forward slashes
WAIFU2X_PATH = "\"" + str(Path(os.path.dirname(os.path.realpath(__file__))).parent) + "/waifu2x-caffe/waifu2x-caffe-cui.exe\""
